...
export async function login(formData){
    const response = await fetch('http://192.168.31.161/api/login', {
        method: 'POST',
        headers: {
    ...
    if(!response.ok){
        ...
        console.log("res data of login FAILED: ", resData);
        error.info = resData;
        throw error;
    }

    const resData = await response.json();
    // console.log("res data of login: ", resData);
    return resData;
}

export async function fetchAllDesigns(){
    const response = await fetch('http://172.18.80.1/api/designs');
...
export async function fetchCatalogueDesigns({accountId, signal}){
    const response = await fetch(`http://192.168.31.161/api/designs/filters?designs=assigned&accountId=${accountId}`, {signal: signal});
...
export async function fetchAssignedRetailers({cardItemId, signal}){
    const response = await fetch(`http://172.18.80.1/api/design-account/${cardItemId}/accounts`, {signal: signal});
  ...
  export async function updateDesignFields({cardItemId, updatedData}){
    const response = await fetch(`http://172.18.80.1/api/designs/${cardItemId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",  
      },
  ...
  export async function addDesignSet({cardItemId, addedData}){
    const response = await fetch(`http://172.18.80.1/api/designs/${cardItemId}/details`,
        {
        method: 'POST',
        headers: {
            "Content-Type": "application/json",
  ...
  export async function updateDesignSet({cardItemId, updatedData, detailsId}){
     const response = await fetch(`http://172.18.80.1/api/designs/${cardItemId}/details/${detailsId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  export async function assignRetailer({cardItemId, formattedData, edit, prevRetailerId, designAccountId}){
    let url = `http://172.18.80.1/api/design-account`;
    let method = "POST";
  ...
  export async function removeRetailer(retailerId){
    const response = await fetch(
      `http://172.18.80.1/api/design-account/${retailerId}`,
      {
        method: "DELETE",
      }
    );
  ...
  export async function fetchAssignedDesigns(){
    const response = await fetch(
      `http://172.18.80.1/api/design-account`
    );
  ...
  export async function fetchOrders({signal, userId}){
    const response = await fetch(
      `http://172.18.80.1/api/orders/user/${userId}/orders`,{signal}
    );
  ...
  export async function fetchRecentOrders({signal,max}){
    const response = await fetch(
      `http://172.18.80.1/api/orders/?pageSize=${max}`,{signal}
    );
  ...
  export async function deleteOrder({orderId, orderItemId}){
    const response = await fetch(
      `http://172.18.80.1/api/orders/${orderId}/orderItem/${orderItemId}`,{
        method: "DELETE",
      }
    );
  ...
  export async function fetchCart({signal, userId}){
    const response = await fetch(
      `http://172.18.80.1/api/carts/user/${userId}/cart`,{signal}
    );
  ...
  export async function deleteCart({cartId, cartItemId}){
    const response = await fetch(
      `http://172.18.80.1/api/carts/${cartId}/cartItem/${cartItemId}`,{
        method: "DELETE",
      }
    );
  ...
  export async function fetchAssignedDesignsForManufacturer(){
    const response = await fetch(
      `http://172.18.80.1/api/designs/filters?designs=assigned`
    );
  ...
  export async function fetchAccountOrdersForManufacturer(){
    const response = await fetch(
      `http://172.18.80.1/api/accounts/account-orders`
    );
  ...
  export async function fetchOrderedDesignsForUser({userId, signal}){
    const response = await fetch(
      `http://172.18.80.1/api/orders/user/${userId}/designs`,{signal}
    );
  ...
  export async function fetchAssignedDesignsVsAccounts(){
    const response = await fetch(
      `http://172.18.80.1/api/accounts/account-designs`
    );
  ...
  export async function fetchAccountsVsUsersForSystem(){
    const response = await fetch(
      `http://172.18.80.1/api/accounts/account-users?accountType=manufacturer`
    );
  ...
  export async function fetchAccountsForSystem(){
    const response = await fetch(
      `http://172.18.80.1/api/accounts/filters/?accountType=manufacturer`
    );
  ...
  export async function fetchUsersForSystem(){
    const response = await fetch(
      `http://172.18.80.1/api/users/filters?accountType=manufacturer`
    );
